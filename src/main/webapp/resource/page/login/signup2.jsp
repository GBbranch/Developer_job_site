...
<body>
    ...
    <script>
        ...
        personalSignupBtn.onclick = function() {
            loadModalContent("${pageContext.request.contextPath}/resource/page/login/signup.jsp"); // 개인회원 가입 JSP 파일 경로
            modal.style.display = "block";
        }

        companySignupBtn.onclick = function() {
            loadModalContent("${pageContext.request.contextPath}/resource/page/login/companysignup.jsp"); // 기업회원 가입 JSP 파일 경로
            modal.style.display = "block";
        }
